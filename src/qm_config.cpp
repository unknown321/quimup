...
qm_config::qm_config() { load_config(); }
...
void qm_config::load_config() {
  ...
  MPD_port_0 = sts.value("MPD_port_0", 6600).toUInt();
  ...
  MPD_port_1 = sts.value("MPD_port_1", 6600).toUInt();
  ...
  MPD_port_2 = sts.value("MPD_port_2", 6600).toUInt();
  ...
  MPD_port_3 = sts.value("MPD_port_3", 6600).toUInt();
  ...
  MPD_port_4 = sts.value("MPD_port_4", 6600).toUInt();
  ...
  if (settings_Y < 0)
    settings_Y = 0;
  settings_W = sts.value("settings_W", 420).toInt();
  settings_H = sts.value("settings_H", 680).toInt();
  // default font sizes
